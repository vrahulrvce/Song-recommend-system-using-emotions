...
import os
mypath="D:\\Entertainment-Recommendation-System-main\\songs\\digust\\"
...
player=vlc.MediaPlayer("D:\\Entertainment-Recommendation-System-main\\songs\\disgust\\"+str(f2[count]))
def button_pressed():
