...
import os
mypath="D:\\Entertainment-Recommendation-System-main\\songs\\angry\\"
...
player=vlc.MediaPlayer("D:\\Entertainment-Recommendation-System-main\\songs\\angry\\"+str(f2[count]))
def button_pressed():
