...
import os
mypath="D:\\Entertainment-Recommendation-System-main\\songs\\happy\\"
...
player=vlc.MediaPlayer("D:\\Entertainment-Recommendation-System-main\\songs\\happy\\"+str(f2[count]))
def button_pressed():
